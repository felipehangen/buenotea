...
cargo build --example sentiment_batch_analysis -p buenotea-sentiment_batch_analysis --release
...
cargo run --example sentiment_batch_analysis -p buenotea-sentiment_batch_analysis --release
