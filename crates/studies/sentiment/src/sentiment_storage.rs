use buenotea_infrastructure::{ApiUrls, SentimentRecord, SentimentInsert, DatabaseClient};
use crate::models::QSSResult;
...
impl SentimentStorage {
    ...
    async fn generate_gpt_explanation(&self, symbol: &str, qss_result: &QSSResult) -> Result<String> {
        ...
        let signal_desc = match qss_result.trading_signal {
            crate::TradingSignal::StrongBuy => "Strong Buy",
            crate::TradingSignal::WeakBuy => "Weak Buy", 
            crate::TradingSignal::Hold => "Hold",
            crate::TradingSignal::WeakSell => "Weak Sell",
            crate::TradingSignal::StrongSell => "Strong Sell",
        };
